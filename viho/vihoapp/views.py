...
def email_readmail(request):
    ...
    return render(request,'applications/email/email-read-mail/email-read-mail.html',context) 
...
@login_required(login_url="/login")
def email_readmail(request):
    return render(request,'applications/email/email-readmail/email-read-mail.html') 
