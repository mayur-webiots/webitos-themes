<template>
    <div class="home-slider">
        <div class="home-wrap row m-0">
                            ...
                            <ul class="share-icons p-0">
                                <li>
                                    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=#url">
                                        <img src="~assets/images/social-icon/4.png" class="img-fluid"
                                            alt="social icon" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.google.co.in/">
                                        <img src="~assets/images/social-icon/5.png" class="img-fluid"
                                            alt="social icon" />
                                    </a>
                                </li>
                                <li>
                                    <a href="http://www.twitter.com/share">
                                        <img src="~assets/images/social-icon/6.png" class="img-fluid"
                                            alt="social icon" />
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="col-xxl-9 col-lg-8 p-0 left-content" :class="isLoaded ? 'sliderBackground bg-size' : ''" :style="{
