        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6">
            <div class="collection-banner p-bottom p-center text-center">
              <a href="shop-left-sidebar.html" class="banner-img" :class="isLoaded ? 'sliderBackground bg-size' : ''"
                :style="{
                  'background-image': 'url(' + image1 + ')',
                }">
                <img src="~assets/images/fashion/banner/1.jpg" class="bg-img" alt=""
          ...
          <div class="col-lg-4 col-md-6">
            <div class="collection-banner p-bottom p-center text-center">
              <a href="shop-left-sidebar.html" class="banner-img" :class="isLoaded ? 'sliderBackground bg-size' : ''"
                ...
                <img src="~assets/images/fashion/banner/2.jpg" class="bg-img" alt=""
                  :style="{ display: isLoaded ? 'none' : '' }" />
              </a>
              <div class="banner-detail">
                <a href="javacript:void(0)" class="heart-wishlist">
          ...
          <div class="col-lg-4">
            <div class="collection-banner p-bottom p-center text-center">
              <a href="shop-left-sidebar.html" class="banner-img" :class="isLoaded ? 'sliderBackground bg-size' : ''"
                ...
                <img src="~assets/images/fashion/banner/3.jpg" class="bg-img" alt=""
                  :style="{ display: isLoaded ? 'none' : '' }" />
              </a>
              <div class="banner-detail">
                <a href="javacript:void(0)" class="heart-wishlist">
...
<script>
  export default {
    data() {
      return {
        isLoaded: false,
        image1: "/_nuxt/assets/images/fashion/banner/1.jpg",
        image2: "/_nuxt/assets/images/fashion/banner/2.jpg",
        image3: "/_nuxt/assets/images/fashion/banner/3.jpg",
      };
    },
    created() {
      this.isLoaded = true;
