<template>
  <div class="menu-right">
    <ul>
      <li>
        <div class="search-box" @click="openSearchBar">
      ...
      <li class="onhover-dropdown cart-dropdown" v-for="(list, index) in cartlist" :key="index">
        <button_animated :buttonContent="'$' + list.cartTotal" featherType="shopping-cart"
...
<script>
  ...
  import button_animated from "../elements/buttons/button_animated.vue";
  export default {
    data() {
      return {
        searchBarOpen: false,
