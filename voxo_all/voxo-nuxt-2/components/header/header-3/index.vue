                    ...
                    <ul class="nav-menu">
                        ...
                        <ul class="nav-submenu menu-content">
                          ...
                          <li>
                            <a href="shop-left-sidebar.html"
                              >Shop Left Sidebar <span>Trending</span></a
                            >
                          </li>
                          <li>
                            <a href="shop-list-infinite.html"
                              >Shop List Infinite</a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shop-with-category.html"
                              >Shop With Category
                              <span class="tren-budge">New</span></a
                            >
                          </li>
                        </ul>
                      </li>
                                ...
                                <div class="link-section">
                                  ...
                                  <div class="submenu-content opensubmegamenu">
                                    <ul class="list">
                                      ...
                                      <li>
                                        <a
                                          href="../email-template/email-template-1.html"
                                          >Email Template 1</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                          href="../email-template/email-template-2.html"
                                          >Email Template 2</a
                                        >
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        <a
                                          href="../email-template/order-success-1.html"
                                          >Order Success 1</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                          href="../email-template/order-success-2.html"
                                          >Order Success 2</a
                                        >
                                      </li>
                                    </ul>
                                ...
                                <div class="link-section">
                                  ...
                                  <div class="submenu-content opensubmegamenu">
                                    <ul class="list">
                                      ...
                                      <li>
                                        <a
                                          href="../email-template/reset-password.html"
                                          >Reset Password</a
                                        >
                                      </li>
                                      <li>
                                    ...
                                    <ul class="list">
                                      <li>
                                        <a href="../invoice/invoice-1.html"
                                          >Invoice 1 Template</a
                                        >
                                      </li>
                                      <li>
                                        <a href="../invoice/invoice-2.html"
                                          >Invoice 2 Template</a
                                        >
                                      </li>
                                      <li>
                                        <a href="../invoice/invoice-3.html"
                                          >Invoice 3 Template</a
                                        >
                                      </li>
                                    </ul>
                                  </div>
                                    ...
                                    <ul class="list">
                                      ...
                                      <li>
                                        <a href="portfolio-4-masonary.html"
                                          >Portfolio 4 Masonary</a
                                        >
                                      </li>
                                      <li>
                                        <a href="portfolio-no-space.html"
                                          >Portfolio No Space</a
                                        >
                                      </li>
                                    </ul>
                                  </div>
                                    ...
                                    <ul class="list">
                                      ...
                                      <li>
                                        <a href="element-collection-banner.html"
                                          >Element Collection Banner</a
                                        >
                                      </li>
                                      <li>
                                        <a href="element-deal-banner.html"
                                          >Element Deal Banner</a
                                        >
                                      </li>
                                      <li>
                        ...
                        <ul class="nav-submenu menu-content">
                          ...
                          <li>
                            <a href="coming-soon.html"
                              >coming soon<span>trending</span></a
                            >
                          </li>
                          <li>
                      ...
                      <li class="mobile-poster d-flex d-xl-none">
                        ...
                        <div class="mobile-contain">
                          ...
                          <p class="font-light">
                            With this Screen option you can use Website like an
                            App.
                          </p>
                          <a
                            href="javascript:void(0)"
...
export default {
  components: { topBar, categoryMenu },
};
</script>
