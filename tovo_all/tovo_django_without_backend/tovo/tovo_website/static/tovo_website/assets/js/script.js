...
$(document).ready(function(){
 ...
 /*------------------------
    ...
    testimonial.owlCarousel({
        ...
        navText:['<img src="/static/tovo_website/assets/images/back.png">','<img src="/static/tovo_website/assets/images/next.png">'],
        dots:false,
        responsive:{
            0:{
                items:1,
    ...
    body_event.on("click", ".color-1", function() {
        $("#color" ).attr("href", "/static/tovo_website/assets/css/color/color-1.css" );
        $("#color-admin" ).attr("href", "/static/tovo_website/assets/css/color/color-1.css" );
        return false;

    });
    body_event.on("click", ".color-2", function() {
        $("#color" ).attr("href", "/static/tovo_website/assets/css/color/color-2.css" );
        $("#color-admin" ).attr("href", "/static/tovo_website/assets/css/color/color-2.css" );
        return false;
    });
    body_event.on("click", ".color-3", function() {
        $("#color" ).attr("href", "/static/tovo_website/assets/css/color/color-3.css" );
        $("#color-admin" ).attr("href", "/static/tovo_website/assets/css/color/color-3.css" );
        return false;
    });
