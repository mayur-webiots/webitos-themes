...
def index(request):
    context={"header_logo":default_header_image,"header_classes":"app1 nav-abs custom-scroll","header_image":header_logos["white_logo"]}
    return render(request,'home/index/index.html',context)

def agency(request):
    context = {"header_logo":default_header_image,"header_classes":"agency nav-fix custom-scroll","header_image":"static/assets/images/logo/9.png"}
...
def app_landing_2(request):
    context={"header_logo":default_header_image,"header_classes":"app2 loding-header nav-abs custom-scroll","header_image":"static/assets/images/logo/1.png","header_animation":True}
    return render(request,'home/app_landing_layout/app_landing_layout.html',context)

def event(request):
    context={"header_logo":default_header_image,"header_classes":"event loding-header nav-abs custom-scroll nav-lg","header_image":header_logos["white_logo"],"body_classes":"event"}
    return render(request,'home/events_layout/events_layout.html',context)

def gym(request):
    context={"header_logo":default_header_image,'header_classes':"gym loding-header nav-abs custom-scroll nav-lg","header_image":header_logos["white_logo"]}
    return render(request,'home/gym_layout/gym_layout.html',context)

def music(request):
    context={"header_logo":default_header_image,"header_classes":"music loding-header header-fixed","header_image":header_logos["white_logo"],"body_classes":"bg-black music"}
    return render(request,'home/music_layout/music_layout.html',context)

def resume(request):
    context={"header_logo":default_header_image,"header_classes":"resume loding-header nav-abs custom-scroll","header_image":header_logos["black_logo"]}
    return render(request,'home/resume_layout/resume_layout.html',context)

def saas1(request):
    context={"header_logo":default_header_image,"header_classes":"saas1 header-fixed loding-header position-absolute  custom-scroll nav-lg","header_image":header_logos["pink_logo"]}
    return render(request,'home/sass_modern_layout/sass_modern_layout.html',context)

def saas2(request):
    context={"header_logo":default_header_image,"header_classes":"saas2 loding-header nav-abs custom-scroll","header_image":header_logos["white_logo"]}
...
def ecommerce(request):
    context={"header_logo":default_header_image,'header_classes':'ecommerce nav-fix','header_image':header_logos["black_logo"]}
    return render(request,'home/ecommerce_layout/ecommerce_layout.html',context)

def portfolio_metro(request):
    context={"header_logo":default_header_image,'header_classes':'dark loding-header custom-scroll nav-lg','body_classes':'agency','header_image':header_logos["black_logo"]}
...
def left_sidebar(request):
    ...
    context = {"header_logo":default_header_image,"breadcrumb":breadcrumb,"header":"dark","layout":"agency"}
...
def details_right_sidebar(request):
    ...
    context = {"header_logo":default_header_image,"breadcrumb":breadcrumb,"breadcrumb":breadcrumb,"header":"dark","layout":"agency"}
...
def video(request):
    context = {"header_logo":header_logos["white_logo"],"header":"header-absolute","layout":"agency"}
...
def portfolio_details_with_big_breadcrumb(request):
    context = {"header_logo":header_logos["white_logo"],"header":"position-absolute"}
