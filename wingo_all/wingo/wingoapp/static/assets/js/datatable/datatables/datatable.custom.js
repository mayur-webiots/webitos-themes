$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "static/assets/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-2').DataTable({
        "ajax": 'static/assets/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "static/assets/json/server-side.json"
    } );
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "static/assets/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "static/assets/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "static/assets/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "static/assets/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "static/assets/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
    ...
    $('#datatable-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "static/assets/ajax/post.php",
            type: "post"
        },
        "columns": [{
            "data": "first_name"
