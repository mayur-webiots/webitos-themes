...
// earning chart
 var options = {
        ...
        plotOptions: {
          radialBar: {
            hollow: {
              margin: 15,
              size: '70%',
              image: 'static/assets/images/email-template/success.png',
              imageWidth: 60,
              imageHeight: 60,
              imageClipped: false
            },
        ...
        fill: {
          type: 'image',
          image: {
            src: ['static/assets/images/user-card/5.jpg'],
          }
        },
        stroke: {
          lineCap: 'round'
...
var optionsuserchart = {
    ...
    colors:[zetaAdminConfig.primary, zetaAdminConfig.secondary, '#51bb25', '#544fff'],
    title: {
